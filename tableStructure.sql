...
CREATE TABLE hazard (
    ...
    isStarted    NUMBER(1) DEFAULT 0 CHECK (isStarted IN (0,1)) NOT NULL,
    isApproved   NUMBER(1) CHECK (isApproved IN (0,1)),
    isChecking   NUMBER(1) DEFAULT 0 CHECK (isChecking IN (0,1)) NOT NULL,
    isConfirmed  NUMBER(1) CHECK (isConfirmed IN (0,1)),
